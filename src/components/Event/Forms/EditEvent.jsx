...
/* actions & helpers */
import { deleteEvent, editEvent, toggleShowForm } from 'actions';
/* data */
...
import { AutoCompleteValidator } from 'react-material-ui-form-validator';
/* css */
  ...
  componentWillReceiveProps(newProps) {
    this.setState({
      event: {
        ...
        seats: {
          value: newProps.event.seats,
          text: newProps.event.seats && newProps.event.seats.toString(),
        },
        price: {
          value: newProps.event.price,
          text: newProps.event.price && newProps.event.price.toString(),
        },
        discount: {
          value: newProps.event.discount,
          text: newProps.event.discount && newProps.event.discount.toString(),
        },
