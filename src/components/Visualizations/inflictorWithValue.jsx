  ...
  <div>
    <div className={styles.heading}>
      ...
      <span className={styles.gold}>
        <img src={`${API_HOST}/apps/dota2/images/tooltips/gold.png`} role="presentation" alt={'gold'} />
        {thing.cost}
      </span>}
      {thing.lore &&
    ...
    <div className={styles.cost}>
      {thing.mc > 0 &&
      <span>
        <img src={`${API_HOST}/apps/dota2/images/tooltips/mana.png`} role="presentation" alt={'mana'} />
        {thing.mc}
      </span>}
      {thing.cd > 0 &&
      <span>
        <img src={`${API_HOST}/apps/dota2/images/tooltips/cooldown.png`} role="presentation" alt={'cooldown'} />
        {thing.cd}
      </span>}
    </div>}
  </div>
  ...
  if (inflictor !== undefined) {
    ...
    if (ability) {
      if (inflictor.includes('attribute_bonus')) {
        ...
        image = '/assets/images/dota2.js/talent_tree.svg';
